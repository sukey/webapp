...
ratemybanter is free software: you can redistribute it and/or modify
it under the terms of the GNU Affero Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

ratemybanter is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
GNU General Public License for more details.

You should have received a copy of the GNU Affero Public License
along with ratemybanter.  If not, see <http://www.gnu.org/licenses/>.
'''


"""
Request people to type in / quote chants or slogans they have overhead from other people.
"""
...
def main():
    ...
    app.create_task(description="Rate my banter", #rename to epic signage?
...
def on_connect(session, task, item):
    session.add_text("Please vote on the following banters by awarding stars for how much you agree with / support the message: 5 for \"Fully-Support\", 1 for \"Disagree\"")
    session.add_text("")
