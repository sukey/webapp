...
"""
A simple task which requests people to look at a series of photos and tag them with keywords. The outcome should be a nice set of photos with interesing metadata.
"""
